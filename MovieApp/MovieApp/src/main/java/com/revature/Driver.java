...
public class Driver {
	...
	public static void main(String[] args) {
		...
		/*System.out.println("Comments for user2: " + cRepoImp.getCommentByUserId(2));
		...
		System.out.println("All Movie Table: " + mRepoImp.selectAllMovies());
		System.out.println("Movie By movieID 1: " + mRepoImp.getMovieByMovieId(1));
